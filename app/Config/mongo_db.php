...
$config['mongo_db']['default']['hostname'] = 'mongodb+srv://project.uhjbz.mongodb.net/test';
$config['mongo_db']['default']['port'] = '';
$config['mongo_db']['default']['username'] = 'mongoAmdin';
$config['mongo_db']['default']['password'] = 'mongoPassword';
$config['mongo_db']['default']['database'] = 'NYParkData';
